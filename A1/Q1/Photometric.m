classdef Photometric
    ...
    methods
        ...
        function obj = solveResiduals(obj)
            for y = 1:obj.h
                for x = 1:obj.w
        ...
        function obj = solveModelOutlierRejection(obj)
            % For every pixel xy
            for y = 1:obj.h
                for x = 1:obj.w
        ...
        function obj = solveModelBasic(obj)
            S = obj.light_dirs;
        ...
        function obj = solveSurfaceHeight(obj, method)
            if (~exist("method", "var"))
                method = 3;
            end
        ...
        function obj = plotSurface(obj, method)
            obj = obj.solveSurfaceHeight(method);
        ...
        function pimage = getResidualImage(obj)
            R = obj.residuals;
            [H, W, N] = size(R);
